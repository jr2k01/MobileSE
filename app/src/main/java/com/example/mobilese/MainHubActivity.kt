...
class MainHubActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        showPendingWorkout()
        // Beim ersten Mal die Einfuehrung, danach der Wegweiser zur naechsten
        // Station des gefuehrten Wegs. Ist der Weg durch, kostet der Aufruf
        // einen Blick in die Einstellungen und tut nichts.
        CoachTour.guide(this)
    }
