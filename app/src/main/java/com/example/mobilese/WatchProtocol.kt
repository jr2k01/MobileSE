 ...
 *
 * **Diese Datei gibt es zweimal** - hier und im wear-Modul. Uhr und Telefon
 * sind getrennte APKs und teilen keinen Code; die Datenverbindung kennt nur
 * einen Pfad und einen Sack aus Werten. Aendert sich hier etwas, muss es dort
 * nachgezogen werden, sonst kommt die Nachricht an und niemand versteht sie.
 *
 * Ein gemeinsames Modul waere die saubere Loesung, brauchte aber eine dritte
 * Gradle-Einheit fuer zwanzig Zeilen Konstanten. Der Verweis hier und drueben
 * ist billiger und ebenso schwer zu uebersehen.
 */
